package ru.poymanov.lunchtoday.web;
...
import ru.poymanov.lunchtoday.util.exception.*;

import javax.servlet.http.HttpServletRequest;
import java.util.Map;
import java.util.Optional;

import static ru.poymanov.lunchtoday.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo forbiddenError(HttpServletRequest req, Exception e) {
