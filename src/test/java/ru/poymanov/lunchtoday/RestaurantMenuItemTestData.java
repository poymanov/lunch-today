...
public class RestaurantMenuItemTestData {
    ...
    public static final RestaurantMenuItem ITEM_1 = new RestaurantMenuItem(ITEM_1_ID, "Item 1", RestaurantMenuTestData.RESTAURANT_MENU_1, 100);
    public static final RestaurantMenuItem ITEM_2 = new RestaurantMenuItem(ITEM_2_ID, "Item 2", RestaurantMenuTestData.RESTAURANT_MENU_1, 200);
    public static final RestaurantMenuItem ITEM_3 = new RestaurantMenuItem(ITEM_3_ID, "Item 1", RestaurantMenuTestData.RESTAURANT_MENU_2, 100);
    public static final RestaurantMenuItem ITEM_4 = new RestaurantMenuItem(ITEM_4_ID, "Item 2", RestaurantMenuTestData.RESTAURANT_MENU_2, 200);
